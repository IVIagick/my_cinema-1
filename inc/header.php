	...
	<body>
		...
		<div class="searchbar">
			<div class="container">
				...
				<form class="navbar-form pull-left search-bar" method="POST" action="index.php?file=Search">
					...
					<select name="searchby" onclick="dateSearch(this.value);" onchange="dateSearch(this.value);" onkeyup="dateSearch(this.value);">
  					...
  					<button type="submit" class="btn recherche-btn" name="bouton-search"><i class="icon-search"></i></button>
				</form>	
			</div>
		</div>
		<div class="menu container">
			<div class="sub-menu">
				<ul class="nav">
					...
					<?php if(isset($_SESSION['id_job'])) { ?><li <?php if(isset($_GET['file']) && $_GET['file'] == 'ListMembres'){ echo "class=\"active\""; }?>><a href="index.php?file=ListMembres">Les Membres</a></li><?php } ?>
					...
					<li id="r-li" <?php if(isset($_GET['file']) && $_GET['file'] == 'ListFilms'){ echo "class=\"active\""; }?>><a href="index.php?file=ListFilms">Les Films</a></li>
				</ul>
			</div>
